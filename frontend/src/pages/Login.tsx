    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl mb-4 sm:mb-6 shadow-xl">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-6 lg:p-8">
          <form onSubmit={onSubmitHandler} className="space-y-4 sm:space-y-5 lg:space-y-6">
            ...
            {currentState === "Sign Up" && (
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="relative">
                  <input
                    type="text"
                    className={`w-full pl-12 pr-4 py-3 sm:py-4 text-base sm:text-lg border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 bg-white text-gray-800 placeholder-gray-500 ${
                      fieldErrors.name 
                  ...
                  {name.length > 0 && (
                    <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                      {fieldErrors.name ? (
                        <svg className="h-5 w-5 sm:h-6 sm:w-6 text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      ) : (
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3 sm:py-4 text-base sm:text-lg border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 bg-white text-gray-800 placeholder-gray-500 ${
                ...
                >
                  <svg className="h-5 w-5 sm:h-6 sm:w-6 text-gray-500 hover:text-gray-700 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    {showPassword ? (
                ...
                <div className="mt-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <div key={requirement.key} className="flex items-center space-x-3">
                        <svg 
                          className={`w-4 h-4 ${requirement.test ? 'text-emerald-600' : 'text-gray-400'}`} 
                          fill="currentColor" 
                          viewBox="0 0 20 20"
                        >
                          {requirement.test ? (
                        ...
                        <span className={`text-sm ${requirement.test ? 'text-emerald-700 font-medium' : 'text-gray-600'}`}>
                          {requirement.label}
                        </span>
                      </div>
                    ))}
            ...
            <div className="flex items-center justify-between text-sm sm:text-base">
              <button
                type="button"
                className="text-blue-700 hover:text-blue-800 font-semibold transition-colors duration-200 hover:underline"
              >
                Forgot password?
              </button>
              <button
            ...
            <div className="pt-4">
              <button 
                type="submit" 
                disabled={isLoading}
                className="w-full py-4 sm:py-5 px-6 bg-blue-600 hover:bg-blue-700 text-white text-base sm:text-lg font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="space-y-3 sm:space-y-4">
            <button className="w-full py-3 sm:py-4 px-4 bg-white border border-gray-300 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 flex items-center justify-center space-x-3 text-gray-700 font-semibold shadow-sm hover:shadow-md text-base sm:text-lg">
        ...
        <div className="text-center mt-6 sm:mt-8">
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            ...
            <a href="#" className="text-blue-700 hover:text-blue-800 font-semibold transition-colors duration-200 hover:underline">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="#" className="text-blue-700 hover:text-blue-800 font-semibold transition-colors duration-200 hover:underline">
