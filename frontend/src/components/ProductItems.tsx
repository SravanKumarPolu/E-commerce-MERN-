      ...
      >
        ...
        <div className="relative overflow-hidden aspect-square">
          ...
          <div className="absolute top-2 sm:top-3 right-2 sm:right-3 flex items-center gap-1">
            ...
            <span className="text-white text-xs font-medium bg-black/50 px-1 rounded">4.8</span>
          </div>
        </div>
        ...
        <div className="p-3 sm:p-4 space-y-2 sm:space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Discount badge */}
            <span className="bg-green-100 text-green-800 text-xs font-semibold px-1 sm:px-2 py-1 rounded-full">
              -20%
            </span>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <div className="flex gap-1">
              <div className="w-3 h-3 sm:w-4 sm:h-4 bg-black rounded-full border border-gray-300"></div>
              <div className="w-3 h-3 sm:w-4 sm:h-4 bg-gray-400 rounded-full border border-gray-300"></div>
              <div className="w-3 h-3 sm:w-4 sm:h-4 bg-blue-500 rounded-full border border-gray-300"></div>
            </div>
          </div>
