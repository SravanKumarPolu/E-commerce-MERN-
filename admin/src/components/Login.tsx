  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-white to-neutral-100 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Enhanced Card */}
        <div className="card-elevated p-12 backdrop-blur-sm">
          {/* Enhanced Header */}
          <div className="text-center mb-12">
            <div className="w-24 h-24 bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl shadow-primary-500/30 border border-primary-400/20">
          ...
          <form className="space-y-8" onSubmit={onSubmitHandler}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full btn-modern btn-primary py-5 text-lg font-bold"
            >
              {isLoading ? (
                <>
